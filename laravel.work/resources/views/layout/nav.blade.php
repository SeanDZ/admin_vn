<div class="blog-masthead" style="background-color: #00b38a;margin-bottom: 10px">
    <div class="container">
        <ul class="nav navbar-nav navbar-left">
            <li>
                <a class="blog-nav-item " href="/post/index" style="color: #dff0d8">首页</a>
            </li>
            <li>
                <a class="blog-nav-item" href="/post/create" style="color: #dff0d8">写文章</a>
            </li>
            <li>
                <a class="blog-nav-item" href="/notices" style="color: #dff0d8">通知</a>
            </li>
            <li>
